...
function createData(ip, port, combined, server, version) {
    return { ip, port, combined, server, version };
}

const rows = [
    createData('102.132.100.10', '80', '102.132.100.10:80', 'Apache', '2.4.41 (Ubuntu)'),
    createData('102.132.100.10', '443', '102.132.100.10:443', 'Apache', '2.4.41 (Ubuntu) with OpenSSL 1.1.1'),
    createData('102.132.100.12', '80', '102.132.100.12:80', 'nginx', '1.18.0'),
    createData('102.132.100.12', '443', '102.132.100.12:443', 'Apache', '2.4.41 (Ubuntu) with OpenSSL 1.1.1'),
    createData('102.132.100.129', '443', '102.132.100.129:443', 'nginx', '1.18.0 with OpenSSL 1.1.1d'),
    createData('102.132.100.13', '443', '102.132.100.13:443', 'Apache', '2.4.41 (Ubuntu) with OpenSSL 1.1.1'),
    createData('102.132.100.13', '80', '102.132.100.13:80', 'Apache', '2.4.41 (Ubuntu) with OpenSSL 1.1.1'),
    createData('102.132.100.134', '443', '102.132.100.134:443', 'nginx', '1.18.0 with OpenSSL 1.1.1d'),
    createData('102.132.100.134', '80', '102.132.100.134:80', 'Apache', '2.4.41 (Ubuntu)'),
];
